...
/*
All Credit for this class goes to SilentChaos512
https://github.com/SilentChaos512/Treasure-Bags/blob/1.21.x/src/main/java/net/silentchaos512/treasurebags/lib/DataResourceManager.java
 */
...
import net.codersdownunder.magiceightball.network.payload.DataResourcesPayload;
    ...
    public Collection<Component> getErrorMessages(ServerPlayer player) {
        if (!this.errorList.isEmpty()) {
            ...
            return ImmutableList.of(
                    Component.literal("[Treasure Bags] The following " + this.typeName + "s failed to load, check your log file:")
